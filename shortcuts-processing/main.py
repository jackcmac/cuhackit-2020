...
#def preproccessing(request):
#request_json = request.get_json()
#requestInput = request_json['inputText']
requestInput = "Elevator North 2.2 -82.83708492093993 34.6759872941903"
curr_loc = Data()
dest_0, dest_1, feetPerStep, curr_loc.long, curr_loc.lat = requestInput.split()
...
requestData = {"startWaypoint": waypoint, "destinationWaypoint": destinationWaypoint, "feetPerStep": feetPerStep}
headers = {'Content-Type': 'application/json'}
response = requests.post(url="https://us-east1-cuhackit2020.cloudfunctions.net/calculate-path", json=requestData, headers=headers)
